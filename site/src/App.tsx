...
X-Payment-Expiry: 2026-03-04T16:05:31Z`,
            ...
            {
              step: '04',
              title: 'Operator NFT (optional)',
              desc: 'Genesis Operator NFT reduces per-call fee to $0.05 and unlocks priority routing. Non-holders execute normally at the base fee tier.',
            },
  ...
  "retry_after_seconds": 5
      ...
      <section className="py-24 px-4 sm:px-6 max-w-4xl mx-auto border-t border-nopipe-green/10">
        ...
        <p className="text-nopipe-gray max-w-2xl leading-relaxed">
          I write my own infrastructure. I lost tokens to a provider's "unsupported asset" policy.
          I built Nopipe so I'd never depend on a pipe I don't control. You probably shouldn't either.
        </p>
      </section>
